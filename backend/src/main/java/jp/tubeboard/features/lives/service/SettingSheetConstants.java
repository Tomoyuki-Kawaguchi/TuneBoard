...
final class SettingSheetConstants {
    ...
    static final String DEFAULT_FORM_TITLE = "バンド申請フォーム";
    static final String DEFAULT_FORM_DESCRIPTION = "出演情報、メンバー、演奏曲を入力してください。";
    static final String DEFAULT_SUBMIT_LABEL = "送信する";
