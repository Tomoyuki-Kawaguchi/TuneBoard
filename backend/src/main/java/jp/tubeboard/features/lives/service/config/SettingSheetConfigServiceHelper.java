...
public class SettingSheetConfigServiceHelper {
    ...
    public FormBlockResponse normalizeBlock(FormBlockRequest block, SettingSheetConfigResponse defaultConfig) {
        ...
        return new FormBlockResponse(
                ...
                type,
                formBuilderHelper.safeTextOrDefault(block.label(), formBuilderHelper.defaultBlockLabel(type)),
                ...
                formBuilderHelper.normalizeAppearance(block.appearance(), formBuilderHelper.defaultAppearance(type)),
                repeatableGroup
                ...
                (repeatableGroup || sectionBlock) ? normalizeBlocks(block.fields(), defaultConfig) : List.of(),
